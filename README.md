...
| 🔍 **Gün 2** | [**Android Tersine Mühendisliğin Tarihi & Gelişimi**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_2_Android_逆向的历史与发展.md) | Eski APK kırma yöntemlerinden modern uygulama korumalarına |
| ⚙️ **Gün 3** | [**CPU Komut Seti Nedir?**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_3_什么是_CPU_指令集.md) | CISC vs. RISC, Android neden ARM kullanıyor |
| 🔥 **Gün 4** | [**Sayı Sistemi Dönüşümleri: 16'lık Sistem Neden Önemli?**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_4_进制转换_为什么16进制很重要.md) | 2'lik, 10'luk, 16'lık sayı sistemlerinin dönüşümü ve uygulamaları |
| 🏗 **Gün 5** | [**Assembly Dili Temelleri**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_5_汇编语言基础.md) | Assembly ve makine kodu ilişkisi, register'ların rolü |
| 🏹 **Gün 6** | [**x86 vs. ARM Assembly**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_6_x86_vs._ARM_汇编.md) | x86 komutları ve ARM komutları arasındaki farklar |
| 📜 **Gün 7** | [**ARM Assembly Komut Analizi**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_7_ARM_汇编指令解析.md) | `MOV`, `ADD`, `SUB`, `LDR`, `STR` komutları |
| 🚀 **Gün 8** | [**Fonksiyon Çağrısı ve Dönüşü**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_8_函数调用与返回.md) | `BL`, `BX`, `CALL`, `RET` komutlarının açıklamaları |
| 🏗 **Gün 9** | [**Android CPU Mimarisi Analizi**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_9_Android_CPU_架构解析.md) | ARMv7, ARMv8, ARM64 arasındaki farklar |
| 📦 **Gün 10** | [**Dalvik vs. ART Çalışma Zamanı**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_10_Dalvik_vs._ART_运行时.md) | Android'in Java sanal makinesi kodu nasıl çalıştırıyor? |
| 🔥 **Gün 11** | [**Android Süreç Yönetimi**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_11_Android_进程管理.md) | Zygote süreci nedir, uygulama süreçlerinin yaşam döngüsü |
| 🚀 **Gün 12** | [**Android İzin Mekanizması**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_12_Android_权限机制.md) | `AndroidManifest.xml` dosyasındaki izinler uygulama güvenliğini nasıl etkiler? |
| 📂 **Gün 13** | [**Android Uygulama Dizin Yapısı**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_13_Android_APP_目录结构.md) | `/data/data` klasörünün analizi, uygulama veri depolama alanı |
| 🔍 **Gün 14** | [**APK Nasıl Yüklenir?**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_14_APK_是如何加载的.md) | Android süreçleri APK dosyalarını nasıl çözümler? |
| 🛠 **Gün 15** | [**El ile ARM Assembly Kodlama (Deney)**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_15_手写_ARM_汇编代码_实验.md) | Basit bir ARM assembly programı yazıp çalıştırmak |
| 🔬 **Gün 16** | [**Disassembler Araçları Tanıtımı**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_16_反汇编工具介绍.md) | IDA Pro, Ghidra, objdump gibi araçlar |
| 🏴 **Gün 17** | [**ELF Dosya Analizi**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_17_ELF_文件解析.md) | `readelf` ile `.so` dosya yapısının incelenmesi |
| 🔥 **Gün 18** | [**Native Katman Nasıl Debug Edilir?**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_18_如何调试_Native_层.md) | LLDB / GDB ile `.so` dosyalarını debug etmek |
| 🚀 **Gün 19** | [**Android Uygulama Güvenlik Mekanizmaları**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_19_Android_APP_安全机制.md) | SELinux, uygulama sandbox'u, root tespiti |
| 🛡 **Gün 20** | [**CTF Tersine Mühendislik Yarışması (Başlangıç)**](./AndroidReverse101/birinci_asama_bilgisayar_temelleri_tersine_muhendislige_giris/Day_20_CTF_逆向挑战_初级.md) | Bir Android tersine mühendislik CTF yarışmasına katılmak |
